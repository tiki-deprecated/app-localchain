...
class Localchain {
  ...
  Future<void> open() async {
    ...
    this._cacheService = CacheService(_dbConfig);
    this._blockService = BlockService(_dbConfig, keystore, _cacheService);
    //verify on open?
  ...
  Future<bool> verify() => _blockService.verifyChain();
  Future<bool> refresh() => _blockService.refreshCache();
}
